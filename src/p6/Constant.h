...
class Game_attribute_constant : public Constant {
  public:
    ...
    virtual const Animation_code* as_animation_block()const;
...
{
  public:
    Game_object_constant(Game_object* gop): Constant(GPL::GAME_OBJECT), gop(gop){}
...
{
  public:
    Animation_block_constant(Animation_code* inf) : Constant(GPL::ANIMATION_BLOCK),inf(inf)
    {

    }
    virtual const Animation_code* as_animation_block() const {return inf;}
  private:
    const Animation_code* inf;
};
#endif