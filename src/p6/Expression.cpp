...
{
	return ret(new Integer_constant(lhs->evaluate()->as_game_object()->touches(rhs->evaluate()->as_game_object())));
}
...
{
	return ret(new Integer_constant(lhs->evaluate()->as_game_object()->near(rhs->evaluate()->as_game_object())));
}
