...
#ifndef YY_YY_RPN_TAB_H_INCLUDED
# define YY_YY_RPN_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_RPN_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "T_PLUS", "T_MINUS", "T_INT_CONSTANT",
  "T_MULTIPLY", "T_DIVIDE", "T_ERROR", "T_SIZE", "T_PRINT", "$accept",
  "my_start_sym", "misc_non_term_symbol", YY_NULLPTR
};
#endif
